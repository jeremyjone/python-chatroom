...
Socket send and recive data Module:
    struct.pack three layers,
        first layer pack message and data.
        second layer pack some necessary message include
        MessageType, MessageLength, messageself/dataself.
        third layer is a encrypt layer.
    struct.unpack four layers,
        first layer is decrypt layer.
        second layer unpack_from by fmt("LLL"), get a tuple
        include MessageType, MessageLength.
        third layer unpack and get the received message.
        forth layer unpack can get messageself/dataself.
